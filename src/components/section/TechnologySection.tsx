  ...
  const technologies = [
    {
      ...
      description:
        "We leverage state-of-the-art neural networks and advanced foundation models. This enables our system to grasp the nuances of medical language, understanding context, recognizing intent, and accurately interpreting complex medical terminology with unprecedented precision. Our NLP technology comprehensively understands that are in complex medical environments, and contextual responses that make sense every time.",
    ...
    },
    {
      ...
      description:
        "Our AI grows smarter with every use. Templates. We make the process by learning directly from your specific organization's data and preference. This intelligence refines in understanding and helps tailor the recommendations, terminology, and workflow that are designed with your unique healthcare practice in mind to accurately and alignment with your unique clinical documentation needs.",
    ...
    >
      ...
      >
        ...
        <p className="text-slate-300 text-base sm:text-lg lg:text-xl max-w-5xl mx-auto px-4">
          At Ghi Technologies, we've built our platform on groundbreaking AI
      ...
      >
        {technologies.map((tech, index) => (
          <motion.div key={index} className="text-left" variants={fadeInUp}>
            <div
              className={`w-12 h-12 ${tech.bgColor} rounded-lg flex items-center justify-center mb-4 sm:mb-6`}
            >
